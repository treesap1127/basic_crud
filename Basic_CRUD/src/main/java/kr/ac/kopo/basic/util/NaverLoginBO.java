...
public class NaverLoginBO {
	...
	public HashMap<String,Object> getUserProfile(OAuth2AccessToken oauthToken) throws IOException{
        ...
        String jsonOriData=response.getBody();
        ObjectMapper mapper = new ObjectMapper();
        HashMap<String,Object> jsonData =mapper.readValue(jsonOriData,HashMap.class);
        HashMap<String,Object> logindata =(HashMap<String, Object>) jsonData.get("response");
        return logindata;
    }
